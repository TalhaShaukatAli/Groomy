...
export abstract class NoteService {
	...
	async updateNote(note: Note) {
		const response = await API.UpdateNoteByID(note);
		return response;
	}
...
class ServiceNoteService extends NoteService {
	...
	async getNotes(id: number) {
		const response = await API.getServiceNotes(id);
		return response;
	}
	...
	async createNote(correspondingID: number, noteData: BaseNote) {
		const response = await API.createServiceNote(correspondingID, noteData);
		return response;
	}
}
...
class AppointmentNoteService extends NoteService {
	 ...
	 */
	async getNotes(id: number) {
		const response = await API.getAppointmentNotes(id);
		return response;
	}
	 ...
	 */
	async createNote(correspondingID: number, noteData: BaseNote) {
		const response = await API.createAppointmentNote(correspondingID, noteData);
		return response;
	}
}
